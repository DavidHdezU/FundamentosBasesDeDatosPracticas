...
CREATE TABLE consultaNormal(
    ...
    estado VARCHAR(50) NOT NULL CHECK(estado <> ''),
    medicamentosRecetados VARCHAR(500) CHECK(medicamentosRecetados <> ''),
    PRIMARY KEY(idConsulta)
);
...
-- Comentarios de consultaEmergencia 	-- {{{
...
-- Comentarios de requerirEmergencia 	-- {{{
...
COMMENT ON COLUMN recibo.nombreTrabajador IS 'El nombre del Trabajador que atendio';
COMMENT ON COLUMN recibo.nombreEstetica IS 'Nombre de la Estetica donde se genera el Recibo';
COMMENT ON COLUMN recibo.monto IS 'Monto del recibo';
-- }}}


-- Comentarios de generaReciboNormal 	-- {{{
...
-- Comentarios de generaReciboEmergencia 	-- {{{
...
COMMENT ON COLUMN pago.esTarjeta IS 'Indica si el pago es con tarjeta';
COMMENT ON COLUMN pago.esEfectivo IS 'Indica si el pago es con efectivo';
-- }}}


-- Comentarios de Pagar 	-- {{{
...
COMMENT ON COLUMN producto.precioUnitario IS 'Precio por unidad del producto';
...
-- Comentarios de generaReciboProducto 	-- {{{
...
-- Comentarios de telefonoSupervisor 	-- {{{
...
-- Comentarios de telefonoVeterinario 	-- {{{
...
-- Comentarios de telefonoEstilista 	-- {{{
...
-- Comentarios de supervisorTrabajaEn 	-- {{{
...
-- Comentarios de veterinarioTrabajaEn 	-- {{{
...
-- Comentarios de estilistaTrabajaEn 	-- {{{
